...
/* Country-code-top-level domains, for guessing a country from a website when
 * a source does not say which one it is. Only the unambiguous ones. */
const TLD_TO_CC = {};
...
module.exports = { COUNTRIES, CODES, PRIORITY, TLD_TO_CC, isWanted, nameOf, langOf };

...
/* Thirty seconds between queries. Measured 2026-08-26, from this machine,
 * while the collector itself was being refused every second query: six
 * queries thirty-five seconds apart, same user-agent, same headers, same
 * two endpoints — six answers, no refusals. The engine is not blocking the
 * address or the user-agent. It is objecting to the pace, and a little over
 * half a minute is a pace it accepts. */
const GAP_MS = parseInt(process.env.SEARCH_GAP_MS || '30000', 10);

...
let answeredRun = 0;
function onAnswered(){
  if(++answeredRun >= 20){ answeredRun = 0; gapMs = Math.max(GAP_MS, Math.round(gapMs * 0.9)); }
...
function onRefused(){ answeredRun = 0; gapMs = Math.min(GAP_MAX_MS, Math.round(gapMs * 2)); }

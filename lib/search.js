 ...
 * thirty-seven queries. A minute and a half between queries is still nine
 * hundred a day, which is twenty-five times what the old ceiling managed. */
const GAP_MAX_MS = parseInt(process.env.SEARCH_GAP_MAX_MS || '90000', 10);
let lastQuery = 0;

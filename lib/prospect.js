...
/* A city may appear under ONE country only. The vet takes the city's name
 * on a page as proof of place, so a name two countries share would file
 * clubs under whichever asked first \u2014 Valencia stays Spain's, C\u00f3rdoba
 * Argentina's, M\u00e9rida Mexico's. Names that are ordinary words or common
 * placenames elsewhere (Bath, York inside "New York", George, Victoria)
 * are left out on purpose, however big the town. */
const CITIES = {
  /* ---- English ---- */
  US: ['New York','Los Angeles','Chicago','Houston','Miami','Dallas','Atlanta','Phoenix','San Diego','Seattle','Boston','Denver',
       'Austin','San Francisco','San Antonio','Philadelphia','Charlotte','Orlando','Tampa','Naples','Palm Beach','Scottsdale',
       'Las Vegas','Portland','Minneapolis','Nashville','Indianapolis','Kansas City','Sacramento',
       'Fort Lauderdale','Boca Raton','Sarasota','Jacksonville','Raleigh','Richmond','Pittsburgh','Cincinnati','Cleveland',
       'Detroit','Milwaukee','Salt Lake City','Albuquerque','Tucson','New Orleans','Memphis','Louisville','Oklahoma City',
       'Omaha','Long Island'],
  CA: ['Toronto','Vancouver','Montreal','Calgary','Ottawa','Edmonton','Winnipeg','Quebec City','Halifax','Mississauga',
       'Saskatoon','Regina','Kitchener','Kelowna',
       'London Ontario','Oakville','Burnaby','Markham','Brampton','Laval','Gatineau','Guelph'],
  AU: ['Sydney','Melbourne','Brisbane','Perth','Adelaide','Gold Coast','Canberra','Newcastle','Hobart','Wollongong',
       'Geelong','Sunshine Coast','Townsville','Cairns','Darwin','Ballarat','Bendigo',
       'Parramatta','Cronulla','Manly','Toowoomba','Mackay','Rockhampton','Launceston','Albury','Wagga Wagga',
       'Coffs Harbour','Noosa','Mornington'],
  GB: ['London','Manchester','Birmingham','Leeds','Glasgow','Bristol','Liverpool','Edinburgh','Sheffield','Newcastle upon Tyne',
       'Nottingham','Leicester','Southampton','Portsmouth','Cardiff','Swansea','Aberdeen','Dundee','Belfast','Brighton',
       'Norwich','Exeter',
       'Cheltenham','Guildford','Wimbledon','Surbiton','Richmond upon Thames','Harrogate','Chester','Stirling',
       'Inverness','Bournemouth','Milton Keynes','Ipswich'],
  IE: ['Dublin','Cork','Galway','Limerick','Waterford','Kilkenny','Sligo','Drogheda','Dundalk','Athlone',
       'Tralee','Ennis','Letterkenny','Carlow','Navan','Naas','Mullingar','Wexford','Bray','Greystones'],
  NZ: ['Auckland','Wellington','Christchurch','Hamilton','Tauranga','Dunedin','Napier','Palmerston North','Nelson',
       'Rotorua','Invercargill','New Plymouth',
       'Whangarei','Whanganui','Timaru','Queenstown','Gisborne'],
  ZA: ['Johannesburg','Cape Town','Durban','Pretoria','Gqeberha','Bloemfontein','Pietermaritzburg','Stellenbosch',
       'Sandton','Centurion','Knysna','Somerset West',
       'Randburg','Midrand','Boksburg','Benoni','Polokwane','Nelspruit','Kimberley','Rustenburg','Paarl','Potchefstroom'],
  IN: ['Mumbai','Delhi','Bangalore','Chennai','Hyderabad','Kolkata','Pune','Ahmedabad','Jaipur','Lucknow','Chandigarh',
       'Gurgaon','Noida','Kochi','Goa','Indore','Nagpur','Coimbatore','Bhopal',
       'Navi Mumbai','Thane','Vadodara','Surat','Mysore','Visakhapatnam','Bhubaneswar','Dehradun'],
  PH: ['Manila','Cebu','Davao','Quezon City','Makati','Taguig','Pasig','Baguio','Iloilo','Bacolod','Cagayan de Oro',
       'Alabang','Pampanga','Batangas','Cavite'],
  PK: ['Karachi','Lahore','Islamabad','Faisalabad','Rawalpindi','Multan','Peshawar'],
  NG: ['Lagos','Abuja','Port Harcourt','Ibadan','Kano','Enugu','Benin City','Lekki','Ikeja','Ikoyi','Victoria Island'],
  KE: ['Nairobi','Mombasa','Kisumu','Nakuru','Eldoret','Kilifi','Naivasha'],
  AE: ['Dubai','Abu Dhabi','Sharjah','Ajman','Ras Al Khaimah','Al Ain','Jumeirah'],
  EG: ['Cairo','Alexandria','Giza','New Cairo','Maadi','Sharm El Sheikh','Hurghada','Zamalek','Heliopolis','El Gouna'],
  GH: ['Accra','Kumasi','Takoradi'],
  UG: ['Kampala','Entebbe'],
  TZ: ['Dar es Salaam','Arusha','Zanzibar'],
  ...
  RW: ['Kigali'],
  MU: ['Port Louis','Grand Baie','Curepipe'],
  SL: ['Freetown'],
  LR: ['Monrovia'],
  GM: ['Banjul','Serekunda'],
  ...
  /* ---- Spanish ---- */
  ES: ['Madrid','Barcelona','Valencia','Sevilla','M\u00e1laga','Zaragoza','Alicante','Murcia','Bilbao','Valladolid','Vigo',
       'A Coru\u00f1a','Granada','Palma de Mallorca','San Sebasti\u00e1n','Santander','Marbella','Tarragona','Girona','C\u00e1diz',
       'Jerez','Salamanca','Pamplona','Oviedo','Gij\u00f3n','Almer\u00eda','Ibiza','Tenerife','Las Palmas',
       'Elche','Castell\u00f3n','Logro\u00f1o','Badajoz','Huelva','Lleida','Burgos','Vitoria','Sabadell','Terrassa',
       'Fuengirola','Estepona','Benidorm','Menorca'],
  MX: ['Mexico City','Guadalajara','Monterrey','Puebla','Canc\u00fan','M\u00e9rida','Quer\u00e9taro','Tijuana','Le\u00f3n','Toluca',
       'Aguascalientes','San Luis Potos\u00ed','Hermosillo','Culiac\u00e1n','Chihuahua','Veracruz','Morelia','Playa del Carmen',
       'Puerto Vallarta','Mazatl\u00e1n','Saltillo','Torre\u00f3n','Los Cabos',
       'Cuernavaca','Oaxaca','Tampico','Durango','Zacatecas','Pachuca'],
  AR: ['Buenos Aires','C\u00f3rdoba','Rosario','Mendoza','La Plata','Mar del Plata','Salta','Tucum\u00e1n','Neuqu\u00e9n',
       'Bah\u00eda Blanca','Corrientes','Bariloche','Tandil','San Isidro','Tigre','Pilar','Quilmes','R\u00edo Cuarto',
       'Rafaela','Pergamino','Olavarr\u00eda','Luj\u00e1n','Posadas','Resistencia','Catamarca','Ushuaia'],
  CO: ['Bogot\u00e1','Medell\u00edn','Cali','Barranquilla','Cartagena','Bucaramanga','Pereira','Manizales','Ibagu\u00e9','C\u00facuta',
       'Santa Marta','Villavicencio','Pasto','Neiva','Popay\u00e1n','Tunja'],
  CL: ['Santiago','Valpara\u00edso','Concepci\u00f3n','Vi\u00f1a del Mar','Antofagasta','La Serena','Temuco','Rancagua','Talca',
       'Puerto Montt','Iquique','Chill\u00e1n','Puerto Varas','Osorno','Valdivia','Punta Arenas','Copiap\u00f3','Calama'],
  PE: ['Lima','Arequipa','Trujillo','Cusco','Piura','Chiclayo','Tacna','Ica','Huancayo','Cajamarca'],
  EC: ['Quito','Guayaquil','Cuenca','Ambato','Manta','Machala','Loja'],
  UY: ['Montevideo','Punta del Este','Maldonado','Colonia del Sacramento','Salto','Paysand\u00fa'],
  PY: ['Asunci\u00f3n','Ciudad del Este','Encarnaci\u00f3n','Luque'],
  VE: ['Caracas','Maracaibo','Barquisimeto','Maracay','San Crist\u00f3bal','Puerto Ordaz'],
  DO: ['Santo Domingo','Punta Cana','Santiago de los Caballeros','La Romana','Puerto Plata'],
  ...
  SV: ['San Salvador'],
  NI: ['Managua'],
  CR: ['San Jos\u00e9','Heredia','Alajuela','Escaz\u00fa','Guanacaste'],
  PA: ['Ciudad de Panam\u00e1','David','Coronado'],
  CU: ['La Habana','Varadero','Santiago de Cuba'],
  PR: ['San Juan','Ponce','Guaynabo','Caguas','Mayag\u00fcez','Dorado'],
  GQ: ['Malabo','Bata'],

  /* ---- Portuguese ---- */
  BR: ['S\u00e3o Paulo','Rio de Janeiro','Belo Horizonte','Bras\u00edlia','Curitiba','Porto Alegre','Salvador','Fortaleza',
       'Recife','Campinas','Florian\u00f3polis','Goi\u00e2nia','Bel\u00e9m','Manaus','Vit\u00f3ria','Natal','Jo\u00e3o Pessoa','Macei\u00f3',
       'Cuiab\u00e1','Campo Grande','Londrina','Maring\u00e1','Joinville','Blumenau','Caxias do Sul','Santos','Sorocaba',
       'Ribeir\u00e3o Preto','S\u00e3o Jos\u00e9 dos Campos','Uberl\u00e2ndia','Juiz de Fora','Niter\u00f3i','Balne\u00e1rio Cambori\u00fa','Pelotas',
       'S\u00e3o Bernardo do Campo','Santo Andr\u00e9','Osasco','Guarulhos','Canoas','Jundia\u00ed','Piracicaba','Franca',
       'Passo Fundo','Crici\u00fama','Cascavel','Ponta Grossa','Gramado','Indaiatuba'],
  PT: ['Lisboa','Porto','Braga','Faro','Coimbra','Aveiro','Leiria','Set\u00fabal','\u00c9vora','Guimar\u00e3es','Cascais','Sintra',
       'Oeiras','Funchal','Ponta Delgada','Albufeira','Portim\u00e3o','Vilamoura','Vila Nova de Gaia',
       'Viseu','Viana do Castelo','Maia','Espinho','P\u00f3voa de Varzim','Figueira da Foz','Loul\u00e9','Tavira'],
  AO: ['Luanda','Benguela','Lubango'],
...
async function vet(url, cc, timeoutMs, city){
  ...
  const RE_CITY = city ? new RegExp('\\b'+String(city).replace(/[.*+?^${}()|[\]\\]/g,'\\$&')+'\\b','i') : null;
...
async function prospectCountry(cc, opts){
  ...
  // The country-wide queries first, then one set per big city. The city is
  // carried along so the vet can accept it as proof of place.
  ...
  for(const {q, city} of queries){
    ...
    for(const r of results){
      ...
      if(v.rec){
        ...
        say(`prospect ${cc}: ${v.rec.name} -> ${v.rec.website}`);
      } else {

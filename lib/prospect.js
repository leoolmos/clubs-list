...
const CITIES = {
  ...
  NG: ['Lagos','Abuja','Port Harcourt','Ibadan','Kano','Enugu','Benin City'],
  KE: ['Nairobi','Mombasa','Kisumu','Nakuru','Eldoret'],
  AE: ['Dubai','Abu Dhabi','Sharjah','Ajman','Ras Al Khaimah'],
  EG: ['Cairo','Alexandria','Giza','New Cairo','Maadi','Sharm El Sheikh','Hurghada'],
  ...
  CO: ['Bogot\u00e1','Medell\u00edn','Cali','Barranquilla','Cartagena','Bucaramanga','Pereira','Manizales','Ibagu\u00e9','C\u00facuta',
       'Santa Marta','Villavicencio','Pasto'],
  CL: ['Santiago','Valpara\u00edso','Concepci\u00f3n','Vi\u00f1a del Mar','Antofagasta','La Serena','Temuco','Rancagua','Talca',
       'Puerto Montt','Iquique','Chill\u00e1n'],
  PE: ['Lima','Arequipa','Trujillo','Cusco','Piura','Chiclayo','Tacna'],

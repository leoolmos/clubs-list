...
const CITIES = {
  ...
  GB: ['London','Manchester','Birmingham','Leeds','Glasgow','Bristol','Liverpool','Edinburgh'],
  ...
  MX: ['Mexico City','Guadalajara','Monterrey','Puebla','Canc\u00fan','M\u00e9rida','Quer\u00e9taro','Tijuana'],
  ...
  PR: ['San Juan','Ponce'],
  ES: ['Madrid','Barcelona','Valencia','Sevilla','M\u00e1laga','Zaragoza'],
  BR: ['S\u00e3o Paulo','Rio de Janeiro','Belo Horizonte','Bras\u00edlia','Curitiba','Porto Alegre','Salvador','Fortaleza','Recife','Campinas','Florian\u00f3polis'],
  PT: ['Lisboa','Porto','Braga','Faro']
};

 ...
 * pages that publish an address rank first. Two spellings per language,
 * taken in turn across the search terms: "club de tenis Sevilla contacto"
 * and "club de padel Sevilla contacto email" rank different pages, and
 * alternating costs nothing — the same number of queries, asked two ways.
 * Portugal says "contactos" where Brazil says "contato". */
const SEARCH_WORDS = {
  Spanish:    ['contacto', 'contacto email'],
  Portuguese: ['contactos', 'contacto email'],
  English:    ['contact', 'contact email']
};
const SEARCH_WORDS_BY_CC = {
  BR: ['contato', 'contato email']
};
